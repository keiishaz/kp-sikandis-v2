            ...
            <div class="card-body">
                ...
                <div class="form-group" style="margin-bottom: 0;">
                    ...
                    <select id="type" name="type" class="form-select {{ $errors->has('type') ? 'is-invalid' : '' }}">
                        <option value="internal" {{ old('type', $unit->type) == 'internal' ? 'selected' : '' }}>Internal (Pemerintah)</option>
                        <option value="external" {{ old('type', $unit->type) == 'external' ? 'selected' : '' }}>Eksternal</option>
                    </select>
