...
@section('title', 'Edit Kendaraan ' . (auth()->user()->role->nama_role === 'admin' ? 'Admin' : 'Operator') . ' — SIKANDIS')
...
<div class="form-container">
    ...
    <nav aria-label="breadcrumb" style="margin-bottom: 24px; font-size: 13.5px;">
        <ol style="list-style: none; padding: 0; margin: 0; display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
            ...
            <li>
                <a href="{{ route('kendaraan.show', $kendaraan->id) }}" style="color: var(--n-500); text-decoration: none; font-weight: 500;">{{ $kendaraan->nama_kendaraan }}</a>
            </li>
            <li style="color: var(--n-400);">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>
            </li>
    ...
    <div class="page-intro" style="margin-bottom: 24px;">
        <h2 class="page-heading">Form Edit Kendaraan</h2>
    </div>

    {{-- FORM CARD --}}
    <div class="card form-page">
        <form action="{{ route('kendaraan.update', $kendaraan->id) }}" method="POST" novalidate>
            @csrf
            @method('PUT')
                    ...
                    <div class="form-section-body">
                        <div class="form-grid-2">
                            <div class="form-group" style="grid-column: 1 / -1;">
                                ...
                                <input type="text" id="nama_kendaraan" name="nama_kendaraan" class="form-input {{ $errors->has('nama_kendaraan') ? 'is-invalid' : '' }}" value="{{ old('nama_kendaraan', $kendaraan->nama_kendaraan) }}" placeholder="Contoh: Toyota Avanza Veloz" autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <div style="display: flex; gap: 12px;">
                                    <div style="flex: 1;">
                                        <input type="text" name="nopol_1" class="form-input" style="text-transform: uppercase; text-align: center;" value="{{ old('nopol_1', $def_nopol_1) }}" placeholder="BD" maxlength="2">
                                    </div>
                                    <div style="flex: 2;">
                                        <input type="text" name="nopol_2" class="form-input" style="text-align: center;" value="{{ old('nopol_2', $def_nopol_2) }}" placeholder="1234" maxlength="4">
                                    </div>
                                    <div style="flex: 1.5;">
                                        <input type="text" name="nopol_3" class="form-input" style="text-transform: uppercase; text-align: center;" value="{{ old('nopol_3', $def_nopol_3) }}" placeholder="XX" maxlength="3">
                                    </div>
                                </div>
                    ...
                    <div class="form-section-body">
                        <div class="form-grid-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="no_rangka" name="no_rangka" class="form-input {{ $errors->has('no_rangka') ? 'is-invalid' : '' }}" style="text-transform: uppercase;" value="{{ old('no_rangka', $kendaraan->no_rangka) }}" placeholder="17 Digit No Rangka">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="no_mesin" name="no_mesin" class="form-input {{ $errors->has('no_mesin') ? 'is-invalid' : '' }}" style="text-transform: uppercase;" value="{{ old('no_mesin', $kendaraan->no_mesin) }}" placeholder="Nomor Mesin">
                ...
                <div class="form-section">
                    ...
                    <div class="form-section-body">
                        <div class="form-grid-2">
                            ...
                            <div class="form-group" id="lokasi_operasional_group" style="{{ old('jenis_penggunaan', $kendaraan->jenis_penggunaan) == 'operasional' ? '' : 'display:none;' }}">
                                <label for="lokasi_operasional_input" class="form-label">Lokasi Operasional <span class="text-danger">*</span></label>
                                <input type="text" id="lokasi_operasional_input" name="lokasi_operasional" class="form-input {{ $errors->has('lokasi_operasional') ? 'is-invalid' : '' }}" value="{{ old('lokasi_operasional', $kendaraan->lokasi_operasional) }}" placeholder="Area Keliling / Nama Unit">
