...
@section('title', 'Edit Profil ' . (auth()->user()->role->nama_role === 'admin' ? 'Admin' : 'Operator') . ' — SIKANDIS')
@section('topbar_title', 'Profil ' . (auth()->user()->role->nama_role === 'admin' ? 'Admin' : 'Operator'))
