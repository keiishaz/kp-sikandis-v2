...
@section('content')
    ...
    <section class="table-container">
        <div class="table-header">
            ...
            <div class="table-header-actions">
                <button type="button" class="btn btn-primary" data-modal-open="modal-unit-create">
    ...
    {{-- Modal: Tambah Unit --}}
    <div class="modal-overlay {{ $errors->any() ? 'active' : '' }}" id="modal-unit-create">
        <div class="modal" role="dialog" aria-modal="true">
            <div class="modal-header">
                <h3 class="modal-title">Tambah Unit</h3>
                <button type="button" class="modal-close" data-modal-close="modal-unit-create">✕</button>
            </div>
            <div class="modal-body">
                <form method="POST" action="{{ route('admin.units.store') }}">
                    ...
                    <div class="form-field">
                        ...
                        <input id="nama_unit" name="nama_unit" value="{{ old('nama_unit') }}" required autofocus>
                        @error('nama_unit')<div class="error-text">{{ $message }}</div>@enderror
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn" data-modal-close="modal-unit-create">Batal</button>
