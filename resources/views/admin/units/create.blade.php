...
@section('title', 'Tambah Unit Kerja - SIKANDIS')
    ...
    <div style="margin-bottom: 24px;">
        <nav aria-label="breadcrumb" style="margin-bottom: 12px; font-size: 13.5px;">
            <ol style="list-style: none; padding: 0; margin: 0; display: flex; align-items: center; gap: 8px;">
                ...
                <li style="color: var(--n-900); font-weight: 600;" aria-current="page">Tambah Unit</li>
            </ol>
        </nav>
        <h2 class="page-heading">Form Tambah Unit</h2>
    </div>
