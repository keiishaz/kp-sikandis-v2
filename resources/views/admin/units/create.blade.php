    ...
    <section class="form-container">
        <div class="card">
            ...
            <nav style="font-size:13px;color:#94a3b8;margin-bottom:20px;display:flex;align-items:center;gap:6px;">
                ...
                <span style="color:#334155;">Tambah Unit</span>
            </nav>

            <h3 style="margin:0 0 20px;font-size:16px;font-weight:600;color:#0f172a;">Form Tambah Unit</h3>

            <form method="POST" action="{{ route('admin.units.store') }}" novalidate>
                @csrf
                ...
                <div class="form-field">
                    ...
                    <input id="nama_unit" name="nama_unit" value="{{ old('nama_unit') }}"
                           style="width:100%;box-sizing:border-box;" placeholder="Contoh: Dinas Kominfo" autofocus>
