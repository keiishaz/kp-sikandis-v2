...
@section('content')
    ...
    <div id="modalPrintFilter" class="modal-overlay">
        <div class="modal" style="max-width: 480px;">
            ...
            <form id="formPrintFilter" action="{{ route(auth()->user()->role->nama_role === 'operator' ? 'operator.kendaraan.print' : 'admin.kendaraan.print') }}" method="GET" target="_blank">
                <input type="hidden" name="status" value="{{ $status }}">
...
var countUrl = '{{ route(auth()->user()->role->nama_role === "operator" ? "operator.kendaraan.print-count" : "admin.kendaraan.print-count") }}';
