...
@section('title', 'Tambah Kendaraan - SIKANDIS')
...
<section class="form-container">
    <div class="card" style="padding: 20px;">
        <nav style="font-size:13px;color:#94a3b8;margin-bottom:24px;display:flex;align-items:center;gap:6px;">
            ...
            <span style="color:#334155;">Tambah Kendaraan</span>
        </nav>

        <h3 style="margin:0 0 28px;font-size:18px;font-weight:600;color:#0f172a;">Form Tambah Kendaraan</h3>

        <form action="{{ route('admin.kendaraan.store') }}" method="POST" novalidate>
            @csrf
            
            <div class="form-group-section" style="margin-bottom: 24px; background: #f8fafc; padding: 20px; border-radius: 10px; border: 1px solid #e2e8f0;">
                ...
                <div class="form-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    <div class="form-field">
                        ...
                        <input id="nama_kendaraan" name="nama_kendaraan" value="{{ old('nama_kendaraan') }}"
                    ...
                    <div class="form-field">
                        ...
                        <div style="display: flex; gap: 12px;">
                            <div style="flex: 1;">
                                <input name="nopol_1" value="{{ old('nopol_1') }}" style="width:100%;box-sizing:border-box;text-transform:uppercase;text-align:center; padding:10px; font-size:14px; border-radius:8px;" placeholder="BD" maxlength="2">
                            </div>
                            <div style="flex: 2;">
                                <input name="nopol_2" value="{{ old('nopol_2') }}" style="width:100%;box-sizing:border-box;text-align:center; padding:10px; font-size:14px; border-radius:8px;" placeholder="1234" maxlength="4">
                            </div>
                            <div style="flex: 1.5;">
                                <input name="nopol_3" value="{{ old('nopol_3') }}" style="width:100%;box-sizing:border-box;text-transform:uppercase;text-align:center; padding:10px; font-size:14px; border-radius:8px;" placeholder="XX" maxlength="3">
                            </div>
                        </div>
            ...
            <div class="form-group-section" style="margin-bottom: 24px; background: #f8fafc; padding: 20px; border-radius: 10px; border: 1px solid #e2e8f0;">
                ...
                <div class="form-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    <div class="form-field">
                        ...
                        <input id="no_rangka" name="no_rangka" value="{{ old('no_rangka') }}" style="width:100%;box-sizing:border-box;text-transform:uppercase; padding:10px 14px; font-size:14px; border-radius:8px;" placeholder="17 Digit No Rangka">
                    ...
                    <div class="form-field">
                        ...
                        <input id="no_mesin" name="no_mesin" value="{{ old('no_mesin') }}" style="width:100%;box-sizing:border-box;text-transform:uppercase; padding:10px 14px; font-size:14px; border-radius:8px;" placeholder="Nomor Mesin">
                    ...
                    <div class="form-field" style="grid-column: 1 / -1; max-width: 50%;">
                        ...
                        <input type="date" id="pajak" name="pajak" value="{{ old('pajak') }}" style="width:100%;box-sizing:border-box; padding: 10px 14px; font-size:14px; border: 1px solid var(--gray-300); border-radius: 8px; outline:none;">
            ...
            <div class="form-group-section" style="margin-bottom: 24px; background: #f8fafc; padding: 20px; border-radius: 10px; border: 1px solid #e2e8f0;">
                ...
                <div class="form-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    ...
                    <div class="form-field" id="lokasi_operasional_group" style="{{ old('jenis_penggunaan') == 'operasional' ? '' : 'display:none;' }}">
                        ...
                        <input type="text" id="lokasi_operasional_input" name="lokasi_operasional" value="{{ old('lokasi_operasional') }}" style="width:100%;box-sizing:border-box; padding:10px 14px; font-size:14px; border:1px solid var(--gray-300); border-radius:8px;" placeholder="Area Keliling / Nama Unit">
            ...
            <div style="display:flex;justify-content:flex-end;gap:12px;padding-top:20px;">
                ...
                <button class="btn btn-primary" type="submit" style="padding:10px 24px;">Simpan Kendaraan</button>
            </div>
        </form>
    </div>
</section>
