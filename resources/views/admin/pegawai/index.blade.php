                    ...
                    @forelse($pegawais as $i => $pegawai)
                        <tr>
                            ...
                            <td class="action-cell">
                                <a href="{{ route('admin.pegawai.edit', $pegawai) }}" class="btn btn-icon btn-secondary" title="Edit">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
                                </a>
                                <form action="{{ route('admin.pegawai.destroy', $pegawai) }}" method="POST" style="display:inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus pegawai ini?');">
                                    @csrf
                                    @method('DELETE')
                        ...
                        <tr>
                            <td colspan="7">
                                <div class="empty-state">
                                    ...
                                    <div class="empty-state-desc">Silakan tambah data pegawai baru.</div>
                                </div>
                            </td>
                        </tr>
                    @endforelse
