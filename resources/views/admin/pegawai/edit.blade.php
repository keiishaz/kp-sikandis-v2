    ...
    <section class="form-container">
        <div class="card">
            ...
            <nav style="font-size:13px;color:#94a3b8;margin-bottom:20px;display:flex;align-items:center;gap:6px;flex-wrap:wrap;">
                ...
                <span style="color:#334155;">{{ $pegawai->nama }}</span>
            </nav>

            <h3 style="margin:0 0 20px;font-size:16px;font-weight:600;color:#0f172a;">Ubah Data Pegawai</h3>
            ...
            <form method="POST" action="{{ route('admin.pegawai.update', $pegawai) }}" novalidate>
                ...
                <div class="form-field">
                    ...
                    <input id="nama" name="nama" value="{{ old('nama', $pegawai->nama) }}"
                ...
                <div class="form-field">
                    ...
                    <input id="nip" name="nip" value="{{ old('nip', $pegawai->nip) }}"
                           style="width:100%;box-sizing:border-box;font-family:monospace;letter-spacing:.5px;">
                ...
                <div class="form-field">
                    ...
                    <input id="jabatan" name="jabatan" value="{{ old('jabatan', $pegawai->jabatan) }}"
                           style="width:100%;box-sizing:border-box;">
                    ...
                    <select id="unit_id" name="unit_id" style="width:100%;box-sizing:border-box;">
                        ...
                        @foreach($units as $unit)
                            <option value="{{ $unit->id }}"
                                {{ old('unit_id', $pegawai->unit_id) == $unit->id ? 'selected' : '' }}>
                                {{ $unit->nama_unit }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-field">
                    ...
                    <select id="sub_unit_id" name="sub_unit_id" style="width:100%;box-sizing:border-box;">
                        ...
                        @foreach($subUnits as $su)
                            <option value="{{ $su->id }}"
                                {{ old('sub_unit_id', $pegawai->sub_unit_id) == $su->id ? 'selected' : '' }}>
                                {{ $su->nama_sub_unit }}
                            </option>
                        @endforeach
                    </select>
