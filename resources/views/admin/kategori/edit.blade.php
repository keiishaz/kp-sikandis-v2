    ...
    <section class="form-container">
        <div class="card">
            ...
            <nav style="font-size:13px;color:#94a3b8;margin-bottom:20px;display:flex;align-items:center;gap:6px;">
                ...
                <span style="color:#334155;">Edit Data</span>
            </nav>

            <h3 style="margin:0 0 20px;font-size:16px;font-weight:600;color:#0f172a;">Form Edit Kategori</h3>
            ...
            <form method="POST" action="{{ route('admin.kategori.update', $kategori) }}" novalidate>
                ...
                <div class="form-field">
                    ...
                    <input id="nama_kategori" name="nama_kategori" value="{{ old('nama_kategori', $kategori->nama_kategori) }}"
                           style="width:100%;box-sizing:border-box;" placeholder="Contoh: Roda Empat">
