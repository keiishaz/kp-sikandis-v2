...
<div class="dashboard">
    ...
    <div class="card" style="margin-bottom: 24px;">
        <div class="card-body" style="padding: 16px 20px;">
            <form method="GET" action="{{ route('log.aktivitas') }}" style="display: flex; gap: 16px; align-items: flex-end; flex-wrap: wrap;">
                ...
                <div style="display: flex; gap: 12px; margin-bottom: 2px;">
                    ...
                    @if(request('q') || request('date'))
                        <a href="{{ route('log.aktivitas') }}" class="btn btn-secondary" style="height: 40px;">Reset</a>
                    @endif
                </div>
