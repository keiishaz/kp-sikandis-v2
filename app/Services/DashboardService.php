...
class DashboardService
{
    ...
    public function getOperatorSummary(): array
    {
        ...
        return [
            ...
            // Lists
            'distribusiKategori'      => $this->dashboardRepo->distribusiKategori(),
            'kendaraanTerbaru'        => $this->dashboardRepo->kendaraanTerbaru(5),
            'daftarPajakSegera'       => $this->dashboardRepo->daftarPajakSegera(8),
            'recentLogs'              => collect(), // Operator doesn't need to see logs by default
        ];
    }
