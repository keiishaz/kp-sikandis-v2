...
class KendaraanAktivitasController extends Controller
{
    public function store(Request $request, Kendaraan $kendaraan)
    {
        ...
        return redirect()->route('kendaraan.show', ['kendaraan' => $kendaraan->id, 'tab' => 'aktivitas'])->with('success', 'Aktivitas berhasil ditambahkan');
    }
    ...
    public function update(Request $request, KendaraanAktivitas $aktivitas)
    {
        ...
        return redirect()->route('kendaraan.show', ['kendaraan' => $aktivitas->kendaraan_id, 'tab' => 'aktivitas'])->with('success', 'Aktivitas berhasil diperbarui');
    }
